package top.bitmore.dax.sdk.openapi.spot.publics.service;
...
public interface PublicService {
     ...
     *
     * @return top.bitmore.dax.sdk.openapi.spot.ccex.domain.ServerTime
     * @see ServerTime
     */
     ...
     * @param code 币对
     * @param size 返回数据条数
     * @return 订单深度信息 top.bitmore.dax.sdk.openapi.spot.ccex.domain.OrderBook
     * @see OrderBook
     */
     ...
     *
     * @return 币对信息列表 top.bitmore.dax.sdk.openapi.spot.ccex.domain.CodeInfo
     * @see CodeInfo
     */
